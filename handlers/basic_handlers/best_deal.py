...
from utils.data_work.equals_data_hotels import update_default_data
...
def bestdeal(message: Message):  #  Поменять
    response_json = hotels_search(update_default_data(get_data(message)))
    data = User.get_data_with_user(message.from_user.id)
